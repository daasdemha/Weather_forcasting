...
function [SkipHours9999, SkipHoursNaN] = AutomatedErrorTesting(TextFilesToBeTested, NaNFilesToBeTested, FilesToBeTested9999)
...
[SkipHoursNaN] = TestNaN(LogID2, SingleDataFileToTest{1});%Testing one file at a time
fprintf(LogID2,'\n');
end
...
[SkipHours9999] = Test9999(LogID2, SingleDataFileToTest9999{1});%Testing one file at a time
fprintf(LogID2,'\n');
end
